...
/*
***	Load data
use data-csrhub/cstat-quarterly-data-csrhub-tickers.dta, clear					/*	Need to start with all CSTAT data?	*/
...
merge 1:1 tic datadate fyearq fqtr using data-csrhub/CSTAT-variables-for-tobin-q.dta
drop if _merge==2
drop _merge 

*	Merge variables for return on equity
merge 1:1 tic datadate fyearq fqtr using data-csrhub/CSTAT-variables-for-return-on-equity.dta
drop if _merge==2
drop _merge


*	Merge liabilities variables
merge 1:1 tic datadate fyearq fqtr using data-csrhub/CSTAT-variables-for-liabilities.dta
drop if _merge==2
drop _merge
...
***	Save
compress
save data-csrhub/cstat-quarterly-data-csrhub-tickers-stnd_firm.dta, replace

*/

***	Load data with standardized firm name
use data-csrhub/cstat-quarterly-data-csrhub-tickers-stnd_firm.dta, clear
...
gen id_cstat=_n
label var id_cstat "(CSTAT) Unique obs id in cstat-quarterly-data-csrhub-tickers-stnd_firm.dta"
...
merge m:1 firm ym using data-csrhub/csrhub-all.dta, nogen
/*    Result                           # of obs.
    -----------------------------------------
    not matched                       292,629
        from master                   292,176  
...
merge m:m cusip datadate using data-csrhub/cstat-quarterly-data-csrhub-tickers-stnd_firm.dta, nogen
/*    Result                           # of obs.
    -----------------------------------------
    not matched                       906,590
        from master                   892,595  
...
***	SAVE
compress
save data-csrhub/csrhub-cstat.dta, replace
...
use data-csrhub/kld-all-clean.dta, clear
...
merge 1:m firm using data-csrhub/kld-all-clean.dta, nogen
/*    Result                           # of obs.
    -----------------------------------------
    not matched                             0
...
*/
compress
save data-csrhub/kld-stnd_firm.dta
*/



use data-csrhub/kld-stnd_firm.dta, clear
...
use "data-csrhub/csrhub-cstat.dta", clear
...
*	Save
compress
save data-csrhub/CSRHub-CSTAT-KLD.dta, replace
